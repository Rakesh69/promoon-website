...
const AddressPopup = () => {
  return (
    <div className="flex flex-wrap flex-col absolute justify-center">
      <div className="bg-blue shadow-md flex justify-between text-white px-5 rounded-lg">
        <svg
        ...
        <Link
          target="_blank"
          href={`https://maps.app.goo.gl/axGPwU2CLZsuQezW9`}
        >
          Go To Map
        </Link>
      </div>
      <div className="w-11 overflow-hidden inline-block ">
        <div className="h-4 bg-blue rotate-45 transform  origin-top-right"></div>
      </div>
    </div>
  );
};
